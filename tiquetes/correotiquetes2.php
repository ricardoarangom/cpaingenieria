...
$destinatario[1]=$row_resultado['correo'];
$destinatario[2]=$row_resultado2['correo'];
...
$mail->Subject = utf8_decode("COMPRA DE TIQUETES AEREOS");
...
$body=('
    <div style="width:100%; background:#eee; position:relative; font-family:sans-serif; padding-bottom:40px">
      ...
      <div style="position:relative; margin:auto; width:750px; background:white; padding:20px">
        ...
        <h3 style="font-weight:100; color:#999" align="center">COMPRA DE TIQUETES AEREOS</h3>
        <hr style="border:1px solid #ccc; width:100%">
        ...
        <p style="padding:0 20px;font-size: 14px">
				La solicitud de tiquetes aereos realizada por '.$row_resultado['nombre']." ".$row_resultado['apellido'].' para el Proyecto/Area '.$nproyecto.', finalizo con la compra de los mismos el '.fechaactual3($row_resultado['fcompra']).'.
        <br><br>
...
$mail->AddAttachment($row_resultado['tiquete'], 'tiquete.pdf');
if(!$mail->Send()) {
