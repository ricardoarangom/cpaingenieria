...
$mail->Subject = utf8_decode("COTIZACION DE TIQUETES AEREOS");
...
$body=('
    <div style="width:100%; background:#eee; position:relative; font-family:sans-serif; padding-bottom:40px">
      ...
      <div style="position:relative; margin:auto; width:750px; background:white; padding:20px">
        ...
        <h3 style="font-weight:100; color:#999" align="center">COTIZACION DE TIQUETES AEREOS</h3>
        <hr style="border:1px solid #ccc; width:100%">
        ...
        <p style="padding:0 20px;font-size: 14px">
				En el proceso de la solicitud de tiquetes aereos realizada por '.$row_resultado['nombre']." ".$row_resultado['apellido'].' para el Proyecto/Area '.$nproyecto.', la cotizacón ya fue cargada en la plataforma, queda pendiente la respectiva autorización.
        <br><br>
				...
				<p style="padding:0 20px; font-size: 14px">	
				Para ver las cotizaciones ingresar a  <a href="https://cpaingenieria.com/" target="_blank">https://cpaingenieria.com/</a>
				</p>
