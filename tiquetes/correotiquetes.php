...
$buscaTiquete="select IdTiquete, tiquetes.IdArea, ccostos, area, empresa, usuarios.nombre, usuarios.apellido, fecha, trayectos, pasajeros from (((tiquetes left join areas on tiquetes.IdArea=areas.IdArea) left join empresas on tiquetes.IdEmpresa=empresas.IdEmpresa) left join usuarios on tiquetes.IdSolicitante=usuarios.IdUsuario) where IdTiquete=".$_GET['id'];
...
$mail->FromName = $row_resultado['nombre']." ".$row_resultado['apellido'];
...
$mail->Subject = utf8_decode("SOLICITUD DE TIQUETES AEREOS");
...
$body=('
    <div style="width:100%; background:#eee; position:relative; font-family:sans-serif; padding-bottom:40px">
      ...
      <div style="position:relative; margin:auto; width:750px; background:white; padding:20px">
        ...
        <h4 style="font-weight:100; color:#999" align="center">SOLICITUD DE TIQUETES AEREOS</h4>
        <hr style="border:1px solid #ccc; width:100%">
        ...
        '.$row_resultado['nombre']." ".$row_resultado['apellido'].' del Proyecto/Area '.$nproyecto.', acaba de realizar una solicitud de tiquetes aereos.
        <br><br>
				...
				<p style="padding:0 20px; font-size: 14px">
				Cargar gastos de todo lo anterior a centro de costos:<br>
				Proyecto o Area: '.$nproyecto.'
				</p>
...
if(!$mail->Send()) {
  ...
  <script>
    swal({
          ...
          html: '<div class="Arila14">¡EL CORREO DE NOTIFICACION FUE ENVIADO CORRECTAMENTE</div><br>',
          type: "success",
