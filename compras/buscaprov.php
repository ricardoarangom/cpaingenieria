      ...
      success: function(respuesta){
        ...
        if(tabla[0]=='ok'){
          var fila = '<table class="tablita Arial14" align="center" border="1">'+
                     ...
                     '<tr class="titulos"><td>PROVEEDOR</td><td></td></tr>';
          ...
          Object.keys(arregloTabla).forEach(key => {
            ...
            fila = fila + '<tr><td>'+arregloTabla[key]+'</td>'+
                          '<td><a href="editaprov.php?id='+key+'" class="btn btn-rosa btn-xs1 btn-block">Consultar/Editar</a></td>'
          })
