...
<div class="contenedor" style="width: 1050px">
	<h4 align="center" class="Century">EDICION Y/O CONSULTA DE PROVEEDORES</h4>
  <form action="grabaprov.php" method="post" enctype="multipart/form-data" name="form1" id="form1" onSubmit="bloquear('boton')">
    ...
    <table border="1" class="tablita Arial14" align="center">
      ...
      <tr>
        ...
        <td colspan="6"><input type="text" name="proveedor" id="proveedor" class="campo-sm" required="required" onblur="aMayusculas(this.value,this.id)" value="<?php echo $row_Recordset1['proveedor'] ?>"></td>
      ...
      <tr>
        ...
        <td colspan="4"><input type="text" 
                               ...
                               id="nit" 
                               class="campo-sm"
															 value="<?php echo $row_Recordset1['documento'] ?>"
                               required="required" 
                               data-trigger="hover"
                               data-toggle="popover"
        ...
        <td colspan="4"><input type="email" 
                               ...
                               id="correo2" 
                               class="campo-sm"
                               value="<?php echo $row_Recordset1['email2'] ?>"
                               data-trigger="hover"
                               data-toggle="popover"
        ...
        <td colspan="5"><input type="email" 
                               ...
                               id="correo3" 
                               class="campo-sm"
                               value="<?php echo $row_Recordset1['email3'] ?>" 
                               data-trigger="hover"
                               data-toggle="popover"
                               data-content="Correo alterno en caso que se requiera que las ordenes de compra lleguen a varios correos"
                               title="ADVERTENCIA"
        ...
        <td colspan="4"><input type="text" name="telefono" id="telefono" class="campo-sm" required="required" value="<?php echo $row_Recordset1['telefono'] ?>"></td>
				<td colspan="3">DIRECCIÓN</td>
        <td colspan="5"><input type="text" name="direccion" id="direccion" class="campo-sm" required="required" value="<?php echo $row_Recordset1['direccion'] ?>"></td>			
			</tr>
      <tr>				
        ...
        <td colspan="5">
          <div id='midiv'>
           <select name="municipio" id="municipio" class="campo-sm Arial12" required="required" >	
						 <option value="<?php echo $row_Recordset1['ciudad'] ?>"><?php echo $municipios[$row_Recordset1['ciudad']]?></option>
          </select>
          </div>
        </td>
      </tr>
      <tr>
        ...
        <td colspan="4"><input type="text" name="contacto" id="contacto" class="campo-sm" required="required" value="<?php echo $row_Recordset1['contacto'] ?>" onblur="aMayusculas(this.value,this.id)"></td>
        <td colspan="3">REPRESENTANTE LEGAL</td>
        <td colspan="5"><input type="text" name="replegal" id="replegal" class="campo-sm" value="<?php echo $row_Recordset1['replegal'] ?>" onblur="aMayusculas(this.value,this.id)"></td>
        
        </tr>
      <tr>
      	<td colspan="3">CELULAR</td>
        <td colspan="4"><input type="tel" name="celular" id="celular" class="campo-sm" required="required" value="<?php echo $row_Recordset1['celular'] ?>"></td>
				<td colspan="3">F. DE CONSTITUCIÓN</td>
        <td colspan="5"><input type="date" name="fconstitucion" id="fconstitucion" class="campo-sm Arial12" required="required" value="<?php echo $row_Recordset1['fconstitucion'] ?>"></td>
      </tr>
      <tr>				
        <td colspan="3">REGIMEN AL CUAL PERTENECE</td>
        <td colspan="4">
          <select class="campo-sm Arial12" name="regimen" id="regimen" required="required">
            <option value=''>Seleccione</option>
        ...
        <td colspan="2" align="center">SI&nbsp;&nbsp;<input type="radio" name="declarante" required="required" value="1" <?php echo $declarante1?>></td>
        <td colspan="3" align="center">NO&nbsp;&nbsp;<input type="radio" name="declarante" required="required" value="0" <?php echo $declarante0?>></td>
      </tr>
      <tr>
        <td colspan="3">GRAN CONTRIBUYENTE</td>
        <td colspan="2" align="center">SI&nbsp;&nbsp;&nbsp;<input type="radio" name="contribuyente" required="required" value="1" <?php echo $granc1?>></td>
        <td colspan="2" align="center">NO&nbsp;&nbsp;&nbsp;<input type="radio" name="contribuyente" required="required" value="0" <?php echo $granc0?>></td>
        <td colspan="3">AUTORETENEDOR</td>
        <td colspan="2" align="center">SI&nbsp;&nbsp;&nbsp;<input type="radio" name="autoretenedor" required="required" value="1" <?php echo $autoret1?>></td>
        <td colspan="3" align="center">NO&nbsp;&nbsp;&nbsp;<input type="radio" name="autoretenedor" required="required" value="0" <?php echo $autoret0?>></td>
			</tr>
			<tr>
				<td colspan="3">CLASIFICACION PROVEEDOR</td>
				<td colspan="4">
					<select name="IdSegmento" class="campo-sm Arial12" id="IdSegmento" required="required" onChange="asignaDocs(this.value)">
						<option value="">Seleccione</option>
					  <?php
						do {  
							?>
							<option value="<?php echo $row_Recordset6['IdClasificacion']?>"><?php echo $row_Recordset6['clasificacion']?></option>
							<?php
    ...
    <table border="1" class="tablita Arial14" align="center">
      ...
      <tr>
        ...
        <td colspan="4">
          <select name="banco" id="banco" class="campo-sm Arial12" required="required">
        ...
        <td colspan="5">
          <select name="clasecuenta" id="clasecuenta" class="campo-sm Arial12" required="required">
            <option value="">Seleccione</option>
      ...
      <tr>
        ...
        <td colspan="4"><input type="text" name="cuenta" class="campo-sm Arial12" required="required" value="<?php echo $row_Recordset1['cuenta'] ?>"></td>
        <td colspan="8"></td>
      </tr>  
    </table>
		<br>
    ...
    <table cellspacing="0" cellpadding="0" class="tablita Arial14" border="1">
      ...
      <tr>
        ...
        <td colspan="4">
          <input type="file" class="campo-sm Arial12" name="rut" id="rut" onChange="validaArchivo(this.files,this.id)">
        </td>
      </tr>
      <tr>
        ...
        <td colspan="4">
          <input type="file" class="campo-sm Arial12" name="fotced" id="fotced" onChange="validaArchivo(this.files,this.id)">
        </td>
      </tr>
      <tr>
        ...
        <td colspan="4">
          <input type="file" class="campo-sm Arial12" name="camcom" id="camcom" onChange="validaArchivo(this.files,this.id)">
        </td>
      </tr>
      <tr>
        ...
        <td colspan="4">
          <input type="file" class="campo-sm Arial12" name="fotresfac" id="fotresfac" onChange="validaArchivo(this.files,this.id)">
        </td>
      </tr>
      <tr>
        ...
        <td colspan="4">
          <input type="file" class="campo-sm Arial12" name="certbanc" id="certbanc" onChange="validaArchivo(this.files,this.id)">
        </td>
      </tr>
    ...
    <br>
      ...
      <button type="submit" name="boton2" class="btn btn-rosa" id="boton">Grabar</button>
...
<script>
  ...
  document.addEventListener('DOMContentLoaded', () => {
    var depto = <?php echo $row_Recordset1['departamento'] ? $row_Recordset1['departamento'] :0 ?>;
    var municipio = <?php echo $row_Recordset1['ciudad'] ? $row_Recordset1['ciudad'] : 0 ?>;
    var regimen = <?php echo $row_Recordset1['regimen'] ?  $row_Recordset1['regimen'] : 0 ?>;		
		var banco = <?php echo $row_Recordset1['IdBanco'] ? $row_Recordset1['IdBanco'] : 0 ?>;
		var clasecuenta = <?php echo $row_Recordset1['clasecuenta'] ? $row_Recordset1['clasecuenta'] : 0 ?>;
    ...
    document.getElementById('regimen').value=regimen;
		...
		document.getElementById('clasecuenta').value=clasecuenta;
